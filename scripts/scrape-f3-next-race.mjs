...
const HOME_URL = "https://www.fiaformula3.com/";
const OUTPUT_PATH = "public/data/f3-next-race.json";
...
async function scrapeF3Schedule() {
  try {
    ...
    console.error("f3 schedule scrape failed:", e.message);
  }
}

await scrapeF3Schedule();
